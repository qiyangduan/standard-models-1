...
In your complex IT system, even for the same custoemr segment, you may have multiple churn models instead of one. Each of those models are created by different algorithms and different parameters. 
