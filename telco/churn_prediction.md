...
### Other Mining Tools
[MiningMart](http://mmart.cs.uni-dortmund.de/research/index.html) seems to be a research project and can be [downloaded](https://sourceforge.net/projects/miningmart/) from Sourceforge.  Telecom Italy used MiningMart to solve the churn problem.
